...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="teachers.php" method="POST" enctype="multipart/form-data">
				...
				<div class="wrap-input100">
					<center><label class="label-inputx">FEEDBACK TEACHERS</label></center>
				</div>

        <div class="wrap-input100 bg3">
					<center><label class="label-inputxs text-white"><?php echo $_SESSION['dept'];  ?></label></center>
				</div>
        ...
        while($row = mysqli_fetch_assoc($results)){
          ...
          echo '<label class="label-inputx">'.$x." ".$row['teacher_name'].'</label>';
          echo "<br>";
