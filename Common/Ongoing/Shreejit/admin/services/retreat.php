...
if(isset($_POST['add_retreat'])){
  ...
  $add_q = "INSERT INTO retreats(retreat_name, retreat_shortintro, retreat_longintro, retreat_hours, retreat_cost, retreat_intro_image, retreat_contact, retreat_pdf) VALUES ('$n','$si','$li','$h','$c','$imgs','$con','$pdfs')";
...
for($i=0;$i<$cnt;$i++){
  ...
  if(isset($_POST['retreat_update_'.$i])){
      ...
      $update_q = "UPDATE retreats SET retreat_name='$n',retreat_shortintro='$si',retreat_longintro='$li',retreat_hours='$h',retreat_cost='$c',retreat_intro_image='$imgs',retreat_contact='$con',retreat_pdf='$pdfs' WHERE retreat_id = '$id'";
