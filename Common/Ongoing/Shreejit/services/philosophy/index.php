      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="service-details-flters">
              ...
              <li data-filter=".filter-<?= $row['philosophy_tag']; ?>"><?= $row['philosophy_tag']; ?></li>
        ...
        <form class="" action="index.php" method="post">
          ...
          <div class="row service-details-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
            ...
            <div class="col-md-4 align-items-stretch filter-<?= $row['philosophy_tag']; ?>">
              <div class="card">
                <div class="card-img">
                  <img src="<?= $img['image_path']; ?>" alt="...">
                </div>
                <div class="card-body">
                  <h5 class="card-title"><a href="philosophy.php?philosophy=<?= $row['philosophy_id']; ?>"><?= $row['philosophy_name']; ?></a></h5>
