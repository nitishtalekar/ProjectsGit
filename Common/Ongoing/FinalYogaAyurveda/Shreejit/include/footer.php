      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="/Shreejit/policy.php#rules">Rules & Regulations</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="/Shreejit/policy.php#terms">Terms of Service</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="/Shreejit/policy.php#privacy">Privacy policy</a></li>
          </ul>
        </div>
