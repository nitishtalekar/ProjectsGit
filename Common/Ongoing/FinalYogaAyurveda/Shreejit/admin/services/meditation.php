<?php
  ...
  if(isset($_POST['meditation_section_del'])){
    for($i=0;$i<count($taglist);$i++){
      if(isset($_POST['meditation_deltag_'.$i])){
        $t = $_POST['meditation_deltag_'.$i];
        $rt = "UPDATE ameditation SET meditation_tag='None' WHERE meditation_tag = '$t';";
        mysqli_query($db, $rt);
  ...
  if(isset($_POST['add_meditation'])){
    ...
    $pri = mysqli_real_escape_string($db, $_POST['meditation_priority_add']);
    ...
    $add_q = "INSERT INTO meditation(meditation_name, meditation_priority, meditation_shortintro, meditation_longintro, meditation_hours, meditation_cost, meditation_tag, meditation_intro_image, meditation_contact, meditation_pdf) VALUES ('$n','$pri','$si','$li','$h','$c','$xtag','$imgs','$con','$pdfs')";
  ...
  for($i=0;$i<$cnt;$i++){
    ...
    if(isset($_POST['meditation_update_'.$i])){
        ...
        $pri = mysqli_real_escape_string($db, $_POST['meditation_priority_'.$i]);
        ...
        $update_q = "UPDATE meditation SET meditation_name='$n',meditation_priority='$pri',meditation_shortintro='$si',meditation_longintro='$li',meditation_hours='$h',meditation_cost='$c',meditation_tag='$xtag',meditation_intro_image='$imgs',meditation_contact='$con',meditation_pdf='$pdfs' WHERE meditation_id = '$id'";
  ...
  if(isset($_POST['meditation_bg'])){
      $meditationbg = mysqli_real_escape_string($db, $_POST['meditationbg']);
      $update_bg = "UPDATE background SET bg_img='$meditationbg' WHERE bg_page = 'meditation';";
      mysqli_query($db, $update_bg);
      echo "<script>alert('Updated');</script>";
    }

    if(isset($_POST['meditation_description'])){
        $description = mysqli_real_escape_string($db, $_POST['description']);
        $update_desc = "UPDATE background SET bg_description='$description' WHERE bg_page = 'meditation';";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
          ...
          <div class="row">
              ...
              <?php
                $q_ser = "SELECT * FROM meditation ORDER BY meditation_priority ASC;";
                    ...
                    <div class="card-body">
                      <form action="meditation.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">meditation NAME</label>
                            ...
                            <input type="text" name="meditation_id_<?=$x?>" class="form-control bg-light border-0 small" style="width:85%;display:none" value="<?=$row_ser['meditation_id']?>" required>
                        </div>
                        
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">meditation Priority</label>&nbsp;&nbsp;
                            <input type="number" name="meditation_priority_<?=$x?>" class="form-control bg-light border-0 small" style="width:35%;" value="<?=$row_ser['meditation_priority']?>" required>
                        </div>
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">meditation Contact Info</label>
                            <input type="text" name="meditation_contact_<?=$x?>" class="form-control bg-light border-0 small" style="width:55%;" value="<?=$row_ser['meditation_contact']?>">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change meditation document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="meditation_pdf_<?=$x?>" style="width:85%;height:10vh;" required>
                            <?php
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="meditation_tag_<?=$x?>" style="width:85%;height:10vh;" required>
                                <?php
                  ...
                  <div class="collapse" id="collapseAddmeditation">
                    <div class="card-body">
                      <form action="meditation.php" method="post">
                        ...
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">meditation Priority</label>&nbsp;&nbsp;
                            <input type="number" name="meditation_priority_add" class="form-control bg-light border-0 small" style="width:35%;" value="99" required>
                        </div>
                        ...
                        <div class="card mb-4">
                          ...
                          <div class="collapse" id="collapseintroimgAdd">
                            <div class="img-card-body" style="height:25vh; overflow-x: hidden; overflow-y:auto;">
                              <?php
                              echo '&nbsp&nbsp<label class="text-uppercase">&nbsp&nbsp<input class="options" type="radio" checked="checked" name="meditation_img_add" value="'.$ch_id.'" required>&nbsp&nbsp<img src="'.$checked_img.'" alt="" style="width:100px"></label>';
                              while($rowimg = mysqli_fetch_assoc($resimg)){
                                $img = $rowimg['image_path'];
                                if($ch_id != $rowimg['image_id']){
                        ...
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">meditation Contact Info</label>&nbsp;&nbsp;
                            <input type="text" name="meditation_contact_add" class="form-control bg-light border-0 small" style="width:55%;" placeholder="Enter Value">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change meditation document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="meditation_pdf_add" style="width:85%;height:10vh;" required>
                            <?php
                            echo '<option selected value="'.$ch_id.'">'.$checked_pdf.'</option>';
                            while($rowimg = mysqli_fetch_assoc($resimg)){
                              $pdfx = $rowimg['pdf_path'];
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="meditation_tag_add" style="width:85%;height:10vh;" required>
                                <?php
