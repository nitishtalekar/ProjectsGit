<?php
  ...
  if(isset($_POST['ayurveda_section_del'])){
    for($i=0;$i<count($taglist);$i++){
      if(isset($_POST['ayurveda_deltag_'.$i])){
        $t = $_POST['ayurveda_deltag_'.$i];
        $rt = "UPDATE aayurveda SET ayurveda_tag='None' WHERE ayurveda_tag = '$t';";
        mysqli_query($db, $rt);
  ...
  if(isset($_POST['add_ayurveda'])){
    ...
    $pri = mysqli_real_escape_string($db, $_POST['ayurveda_priority_add']);
    ...
    $add_q = "INSERT INTO ayurveda(ayurveda_name, ayurveda_priority, ayurveda_shortintro, ayurveda_longintro, ayurveda_hours, ayurveda_cost, ayurveda_tag, ayurveda_intro_image, ayurveda_contact, ayurveda_pdf) VALUES ('$n','$pri','$si','$li','$h','$c','$xtag','$imgs','$con','$pdfs')";
  ...
  for($i=0;$i<$cnt;$i++){
    ...
    if(isset($_POST['ayurveda_update_'.$i])){
        ...
        $pri = mysqli_real_escape_string($db, $_POST['ayurveda_priority_'.$i]);
        ...
        $update_q = "UPDATE ayurveda SET ayurveda_name='$n',ayurveda_priority='$pri',ayurveda_shortintro='$si',ayurveda_longintro='$li',ayurveda_hours='$h',ayurveda_cost='$c',ayurveda_tag='$xtag',ayurveda_intro_image='$imgs',ayurveda_contact='$con',ayurveda_pdf='$pdfs' WHERE ayurveda_id = '$id'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
          ...
          <div class="row">
              ...
              <?php
                $q_ser = "SELECT * FROM ayurveda ORDER BY ayurveda_priority ASC;";
                    ...
                    <div class="card-body">
                      <form action="ayurveda.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">ayurveda NAME</label>
                            ...
                            <input type="text" name="ayurveda_id_<?=$x?>" class="form-control bg-light border-0 small" style="width:85%;display:none" value="<?=$row_ser['ayurveda_id']?>" required>
                        </div>
                        
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">ayurveda Priority</label>&nbsp;&nbsp;
                            <input type="number" name="ayurveda_priority_<?=$x?>" class="form-control bg-light border-0 small" style="width:35%;" value="<?=$row_ser['ayurveda_priority']?>" required>
                        </div>
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">ayurveda Contact Info</label>
                            <input type="text" name="ayurveda_contact_<?=$x?>" class="form-control bg-light border-0 small" style="width:55%;" value="<?=$row_ser['ayurveda_contact']?>">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change ayurveda document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="ayurveda_pdf_<?=$x?>" style="width:85%;height:10vh;" required>
                            <?php
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="ayurveda_tag_<?=$x?>" style="width:85%;height:10vh;" required>
                                <?php
                  ...
                  <div class="collapse" id="collapseAddayurveda">
                    <div class="card-body">
                      <form action="ayurveda.php" method="post">
                        ...
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">ayurveda Priority</label>&nbsp;&nbsp;
                            <input type="number" name="ayurveda_priority_add" class="form-control bg-light border-0 small" style="width:35%;" value="99" required>
                        </div>
                        ...
                        <div class="card mb-4">
                          ...
                          <div class="collapse" id="collapseintroimgAdd">
                            <div class="img-card-body" style="height:25vh; overflow-x: hidden; overflow-y:auto;">
                              <?php
                              echo '&nbsp&nbsp<label class="text-uppercase">&nbsp&nbsp<input class="options" type="radio" checked="checked" name="ayurveda_img_add" value="'.$ch_id.'" required>&nbsp&nbsp<img src="'.$checked_img.'" alt="" style="width:100px"></label>';
                              while($rowimg = mysqli_fetch_assoc($resimg)){
                                $img = $rowimg['image_path'];
                                if($ch_id != $rowimg['image_id']){
                        ...
                        <div class="d-flex justify-content-center mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">ayurveda Contact Info</label>&nbsp;&nbsp;
                            <input type="text" name="ayurveda_contact_add" class="form-control bg-light border-0 small" style="width:55%;" placeholder="Enter Value">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change ayurveda document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="ayurveda_pdf_add" style="width:85%;height:10vh;" required>
                            <?php
                            echo '<option selected value="'.$ch_id.'">'.$checked_pdf.'</option>';
                            while($rowimg = mysqli_fetch_assoc($resimg)){
                              $pdfx = $rowimg['pdf_path'];
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="ayurveda_tag_add" style="width:85%;height:10vh;" required>
                                <?php
