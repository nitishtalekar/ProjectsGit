<?php
  ...
  if(isset($_POST['add_philosophy'])){
    ...
    $add_q = "INSERT INTO philosophy(philosophy_name, philosophy_shortintro, philosophy_longintro, philosophy_hours, philosophy_cost, philosophy_tag, philosophy_intro_image, philosophy_contact, philosophy_pdf) VALUES ('$n','$si','$li','$h','$c','$xtag','$imgs','$con','$pdfs')";
  ...
  for($i=0;$i<$cnt;$i++){
    ...
    if(isset($_POST['philosophy_update_'.$i])){
        ...
        $update_q = "UPDATE philosophy SET philosophy_name='$n',philosophy_shortintro='$si',philosophy_longintro='$li',philosophy_hours='$h',philosophy_cost='$c',philosophy_tag='$xtag',philosophy_intro_image='$imgs',philosophy_contact='$con',philosophy_pdf='$pdfs' WHERE philosophy_id = '$id'";
                    ...
                    <div class="card-body">
                      <form action="philosophy.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">philosophy NAME</label>
                            ...
                            <input type="text" name="philosophy_id_<?=$x?>" class="form-control bg-light border-0 small" style="width:85%;display:none" value="<?=$row_ser['philosophy_id']?>">
                        </div>
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">philosophy Contact Info</label>
                            <input type="text" name="philosophy_contact_<?=$x?>" class="form-control bg-light border-0 small" style="width:85%;" value="<?=$row_ser['philosophy_contact']?>">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change philosophy document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="philosophy_pdf_<?=$x?>" style="width:85%;height:10vh;">
                            <?php
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="philosophy_tag_<?=$x?>" style="width:85%;height:10vh;">
                                <?php
                  ...
                  <div class="collapse" id="collapseAddphilosophy">
                    <div class="card-body">
                      <form action="philosophy.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">philosophy Contact Info</label>
                            <input type="text" name="philosophy_contact_add" class="form-control bg-light border-0 small" style="width:85%;" placeholder="Enter Value">
                        </div>
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">Change philosophy document</label>
                          <select class="js-example-basic-single custom-select mr-sm-2" name="philosophy_pdf_add" style="width:85%;height:10vh;">
                            <?php
                      ...
                      <div class="col-lg-6">
                          <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                            <label class="text-uppercase" style="font-size:15px;">Change Section</label>
                              <select class="js-example-basic-single custom-select mr-sm-2" name="philosophy_tag_add" style="width:85%;height:10vh;">
                                <?php
                                  echo '<option selected disabled value="">Select Section</option>';
                                  $tag_qu = "SELECT DISTINCT philosophy_tag FROM philosophy;";
                                  $restag = mysqli_query($db, $tag_qu);
                                  while($rowtag = mysqli_fetch_assoc($restag)){
                                    $tagg= $rowtag['philosophy_tag'];
