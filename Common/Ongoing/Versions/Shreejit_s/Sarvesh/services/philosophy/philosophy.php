        ...
        <div class="container">
          ...
          <div class="row counters">
            ...
            <div class="col-lg-6 col-12 text-center">
              <span style="font-size:70px" data-toggle="counter-up"><?= $row['philosophy_hours']; ?></span>
              <p style="font-size:30px">Hours</p>
            </div>

            <div class="col-lg-6 col-12 text-center" >
              <span style="font-size:70px" data-toggle="counter-up"><?= $row['philosophy_cost']; ?></span>
