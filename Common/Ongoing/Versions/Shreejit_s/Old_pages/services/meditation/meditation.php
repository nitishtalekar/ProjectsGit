      ...
      <section class="about" data-aos="fade-up">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <center><img src="/Shreejit/assets/img/background-img.png" class="img-fluid"  alt=""></center>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row counters">
            ...
            <div class="col-lg-6 col-12 text-center">
              <span style="font-size:70px" data-toggle="counter-up">232</span>
              <p style="font-size:30px">Hours</p>
            </div>
  
            <div class="col-lg-6 col-12 text-center" >
              <span style="font-size:70px" data-toggle="counter-up">521</span>
