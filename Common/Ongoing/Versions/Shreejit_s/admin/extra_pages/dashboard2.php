...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="/Shreejit/assets/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="/Shreejit/assets/js/demo/chart-area-demo.js"></script>
  <script src="/Shreejit/assets/js/demo/chart-pie-demo.js"></script>
