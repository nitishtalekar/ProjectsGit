...
<?php include($_SERVER['DOCUMENT_ROOT']."/Shreejit/include/header.php")?>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="herohead" class="d-flex justify-cntent-center align-items-center" style="background: linear-gradient(to right, rgba(0, 128, 129, 0.8), rgba(30, 67, 86, 0.6)), url("<?= $img['image_path']; ?>") center top no-repeat;">
      ...
      <div class="container">
        ...
        <form class="" action="index.php" method="post">
          ...
          <div class="row service-details-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
            ...
            $query = "SELECT * FROM yoga ORDER BY yoga_id desc;";
            $results = mysqli_query($db, $query);
            while($row = mysqli_fetch_assoc($results)){
