                  ...
                  <div class="card-body">
                    <form action="contact.php" method="post">
                      <div class="d-flex justify-content-around">
                          <textarea class="form-control bg-light border-0 small" style="width:80%;height:10vh"><?=$rowcon['Number']?></textarea>
                          <button class="btn btn-primary" type="button" name = 'phone'>
                            Update
                          </button>
                      </div>
                    </form>
              ...
              <div class="col-lg-6">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <form action="contact.php" method="post">
                      <div class="d-flex justify-content-around">
                          <textarea class="form-control bg-light border-0 small" style="width:80%;height:10vh"><?=$rowcon['Email']?></textarea>
                          <button class="btn btn-primary" type="button" name = 'mail'>
                            Update
                          </button>
                      </div>
                    </form>
              ...
              <div class="col-lg-12">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <form action="contact.php" method="post">
                      <div class="d-flex justify-content-around">
                          <textarea class="form-control bg-light border-0 small" style="width:80%;height:10vh"><?=$rowcon['Address']?></textarea>
                          <button class="btn btn-primary" type="button" name = 'address'>
                            Update
                          </button>
                      </div>
                    </form>
