                  ...
                  <div class="card-body">
                    <form action="team.php" method="post">
                      ...
                      <div class="d-flex justify-content-around mb-3 mt-5">
                        <button class="btn btn-primary" type="submit" style="width:100%" name='update_<?=$rowteam['retreat_id']?>'>
                          Update
                        </button>
                      </div>
                      <div class="d-flex justify-content-around mb-3 mt-2">
                        <button class="btn btn-danger" type="submit" style="width:100%" name='delete_<?=$rowteam['retreat_id']?>'>
                          Remove
                        </button>
                      </div>
