...
<head>
  ...
  <title>Admin - ayurvedaAyurveda</title>
                    ...
                    <form action="team.php" method="post">
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">ayurveda NAME</label>
                          <input type="text" class="form-control bg-light border-0 small" style="width:85%;" value="<?=$row_ser['ayurveda_name']?>">
                      </div>
                      
                      <div class="d-flex justify-content-around mb-3">
                        <label class="text-uppercase" style="font-size:15px;">Short Intro</label>
                          <textarea class="form-control bg-light border-0 small" style="width:85%;height:15vh" ><?=$row_ser['ayurveda_shortintro']?></textarea>
                      </div>
                      
                      <div class="d-flex justify-content-around mb-3">
                        <label class="text-uppercase" style="font-size:15px;">Long Intro</label>
                          <textarea class="form-control bg-light border-0 small" style="width:85%;height:15vh" ><?=$row_ser['ayurveda_longintro']?></textarea>
                      </div>
                      <?php    
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="collapse" id="collapseintroimg<?=$row_ser['ayurveda_id']?>">
                          <div class="img-card-body" style="height:25vh; overflow-x: hidden; overflow-y:auto;">
                            <?php 
                            echo '&nbsp&nbsp<label class="text-uppercase">&nbsp&nbsp<input class="options" type="radio" checked="checked" name="homebg" value="'.$row_ser['ayurveda_intro_image'].'" required>&nbsp&nbsp<img src="'.$checked_img.'" alt="" style="width:100px"></label>';
                      ...
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase mr-2" style="font-size:15px;">Hours</label>
                          <input type="number" class="form-control bg-light border-0 small" style="width:45%;" value="<?=$row_ser['ayurveda_hours']?>">
                          <label class="text-uppercase mr-2" style="font-size:15px;">Cost</label>
                            <input type="number" class="form-control bg-light border-0 small" style="width:45%;" value="<?=$row_ser['ayurveda_cost']?>">
                      </div>
                      <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                        <label class="text-uppercase" style="font-size:15px;">ayurveda Contact Info</label>
                          <input type="text" class="form-control bg-light border-0 small" style="width:85%;" value="<?=$row_ser['ayurveda_contact']?>">
                      </div>
                      ...
                      <div class="d-flex justify-content-around mb-3 mt-5">
                        <button class="btn btn-primary" type="submit" style="width:100%" name='update_<?=$rowteam['ayurveda_id']?>'>
                          Update
                        </button>
                      </div>
                      <div class="d-flex justify-content-around mb-3 mt-2">
                        <button class="btn btn-danger" type="submit" style="width:100%" name='delete_<?=$rowteam['ayurveda_id']?>'>
                          Remove
                        </button>
                      </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>ayurvedaAyurvedaKarona</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
