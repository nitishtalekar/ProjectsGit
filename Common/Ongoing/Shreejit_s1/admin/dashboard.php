<?php
  ...
  if(isset($_POST['dashboard_rules'])){
    ...
    $tq = "UPDATE policy SET rules='$rules';";
    mysqli_query($db, $tq);
    header('location: dashboard.php');
  }
  ...
  if(isset($_POST['dashboard_terms'])){
    ...
    $tq = "UPDATE policy SET terms='$terms';";
    mysqli_query($db, $tq);
    header('location: dashboard.php');
  }
  ...
  if(isset($_POST['dashboard_privacy'])){
    ...
    $tq = "UPDATE policy SET privacy='$privacy';";
    mysqli_query($db, $tq);
    header('location: dashboard.php');
  }
?>
                      ...
                      <form action="dashboard.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3" style="align-items:center;">
                          <label class="text-uppercase" style="font-size:15px;">Event NAME</label>
                            <input type="text" name="event_name_<?=$x?>" class="form-control bg-light border-0 small" style="width:85%;" value="<?=$row_ser['home_title']?>">
                        ...
                        <div class="d-flex justify-content-around mb-3">
                          <label class="text-uppercase" style="font-size:15px;">Event Link</label>
                            <textarea class="form-control bg-light border-0 small" name="event_link_<?=$x?>"style="width:85%;" ><?=$row_ser['home_link']?></textarea>
                        </div>
                  ...
                  <div class="collapse" id="collapseAddevent">
                    <div class="card-body">
                      <form action="dashboard.php" method="post">
                        ...
                        <div class="d-flex justify-content-around mb-3">
                          <label class="text-uppercase" style="font-size:15px;">Event Link</label>
                            <textarea class="form-control bg-light border-0 small" name="event_link_add"style="width:85%;" >Event Link</textarea>
                        </div>
              ...
              <div class="col-lg-12">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <form action="dashboard.php" method="post">
                      <div class="d-flex justify-content-around">
                          <textarea name="rules" class="form-control bg-light border-0 small" style="width:80%;height:10vh"> <?=$rowpolicy['rules']?> </textarea>
                ...
                <div class="col-lg-12">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      <form action="dashboard.php" method="post">
                        <div class="d-flex justify-content-around">
                            <input name="terms" class="form-control bg-light border-0 small" style="width:80%;height:10vh" value="<?=$rowpolicy['terms']?>">
                ...
                <div class="col-lg-12">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      <form action="dashboard.php" method="post">
                        <div class="d-flex justify-content-around">
                            <textarea name="privacy" class="form-control bg-light border-0 small" style="width:80%;height:10vh"> <?=$rowpolicy['privacy']?> </textarea>
