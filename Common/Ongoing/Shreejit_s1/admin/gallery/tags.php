                   ...
                   <div class="col-lg-12">
                          ...
                          while($tagrow = mysqli_fetch_assoc($tagres)){
                           ...
                           ?>
                            <div class="col-lg-3 mx-2 mb-3">
                              <button class="btn btn-primary text-uppercase" type="button" name="tag" style="width:100%">
                                Add to <?=$tag?>
                              </button>
                            </div>
                          <?php }} ?>
                          <div class="col-lg-12 mx-2 mb-3">
                            <div class="d-flex justify-content-around">
                                <input type="text" class="form-control bg-light border-0 small" style="width:80%;" placeholder="New Tag"> 
                                <button class="btn btn-primary text-uppercase" type="button" name="new_tag" >
                                  Add New Tag
                                </button>
                            </div>
                          </div>
