...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item <?= $td ?>">
    <a class="nav-link" href="/Shreejit/admin/dashboard.php">
  ...
  <li class="nav-item <?= $th ?>">
    <a class="nav-link" href="/Shreejit/admin/home.php">
  ...
  <li class="nav-item <?= $tg ?>">
    ...
    <div id="collapseGal" class="collapse <?= $tg_show ?>" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="/Shreejit/admin/gallery/gallery.php">Add/Delete Images</a>
        <a class="collapse-item" href="/Shreejit/admin/gallery/tags.php">Tags</a>
      </div>
    </div>
  </li>
  
  <li class="nav-item <?= $tt ?>">
    <a class="nav-link" href="/Shreejit/admin/team.php">
      <i class="fas fa-users"></i>
      <span>Team</span></a>
  </li>
  
  <li class="nav-item <?= $tc ?>">
    <a class="nav-link" href="/Shreejit/admin/contact.php">
  ...
  <li class="nav-item <?= $ts ?>">
    ...
    <div id="collapseTwo" class="collapse <?= $ts_show ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="/Shreejit/admin/services/retreat.php">Retreats</a>
        <a class="collapse-item" href="/Shreejit/admin/services/yoga.php">Yoga</a>
        <a class="collapse-item" href="/Shreejit/admin/services/ayurveda.php">Ayurveda</a>
        <a class="collapse-item" href="/Shreejit/admin/services/meditation.php">Meditation</a>
        <a class="collapse-item" href="/Shreejit/admin/services/philosophy.php">Philosophy</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item <?= $tb ?>">
    ...
    <div id="collapseUtilities" class="collapse <?= $tb_show ?>" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="/Shreejit/admin/blog/blog.php">Page</a>
        <a class="collapse-item" href="/Shreejit/admin/blog/post.php">Post</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item <?= $ti ?>">
    <a class="nav-link" href="/Shreejit/admin/media/images.php">
  ...
  <li class="nav-item <?= $tv ?>">
    <a class="nav-link" href="/Shreejit/admin/media/videos.php">
