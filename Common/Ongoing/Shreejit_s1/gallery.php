        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-<?= $row['gallery_tag']; ?>"><?= $row['gallery_tag']; ?></li>
            ...
            <div class="col-lg-4 col-md-6 filter-<?= $row['gallery_tag']; ?>">
              <div class="portfolio-item">
                ...
                <div class="portfolio-info">
                  <h3><a href="<?= $img['image_path']; ?>" data-gall="portfolioGallery" class="venobox" title="<?= $row['gallery_tag']; ?>"><?= $row['gallery_tag']; ?></a></h3>
