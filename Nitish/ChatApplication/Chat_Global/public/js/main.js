...
const ENDPT = 'https://chat-application-nt.herokuapp.com/';
...
function outputMessage(message) {
  ...
  if( message.username === username ){
    ...
    div.innerHTML = `<div class="message-data align-right fade-in-message">
        <span class="message-data-name" >${time}</span> &nbsp;
    ...
    div.innerHTML = `<div class="d-flex justify-content-center fade-in-message">
      <div class="text-head text-capitalize">
        <i class="fa fa-handshake-o me" aria-hidden="true"></i> ${time} &nbsp; ${message.text}
      </div>
    </div>`;
  }
    ...
    div.innerHTML = `<div class="d-flex justify-content-center fade-in-message">
      <div class="text-head text-capitalize">
          <i class="fa fa-sign-out me" aria-hidden="true"></i> ${time} &nbsp; ${message.text}
      </div>
    </div>`;
  }
    ...
    div.innerHTML = `<div class="d-flex justify-content-center fade-in-message">
      <div class="text-head text-capitalize">
        <i class="fa fa-sign-in me" aria-hidden="true"></i> ${time} &nbsp; ${message.text}
      </div>
    </div>`;
  }
  else{
...
function outputUsers(users) {
  ...
  div.innerHTML = `
    ${users.map(user => `<div class="col-6 mb-2 text-capitalize">
