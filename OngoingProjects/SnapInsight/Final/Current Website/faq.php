<?php 
      require 'shortcuts/faq_header.html';
 ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/tailwindcss/1.2.0/tailwind.min.css" type="text/css" media="screen" title="no title" charset="utf-8" />
       
       <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162081819-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-162081819-1');
</script>
<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/68e3b3e686e500593fc99b6bd/e4a498ec1931f0ae461ebae1f.js");</script>
    </head>
    <body class="bg-gray-100 font-display">
                    ...
                    <dl class="mt-8 mx-auto max-w-screen-sm lg:max-w-screen-lg flex flex-col lg:flex-row lg:flex-wrap">
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                    We at Snapinsight specialise in solving your everyday problems with the help of Artificial Intelligence and Machine learning. We create efficient and effective solutions to make your life easier.  
                                </dd>
                            </div>
                        </div>
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                <dt class="question">
                                    <div class="flex justify-between">
                                        <div class="text-indigo-800 font-semibold">
                                            Are there any solutions created by Snapinsight? 
                                        </div>
                                        <div>
                                            <svg fill=currentColor class="question-chevron group-hover:bg-gray-500 h-5 block text-indigo-800 bg-gray-400 rounded-full p-1" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="currentColor" stroke-width="1" fill=currentColor fill-rule="evenodd">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                   Yes, Moodish is our first solution created. Know more about it, Visit <a href="https://snapinsight.net/solutions/moodish/comingsoon/index.html">Moodish</a>
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                   Absolutely, All our solutions are easy to use and free for everyone. You can avail to them by downloading the respective apps from App Store and Play Store, subscribe to our mailing list and get notified about our solutions.
                                </dd>
                            </div>
                        </div>
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                <dt class="question">
                                    <div class="flex justify-between">
                                        <div class="text-indigo-800 font-semibold">
                                            Can I be a part of Snapinsight?
                                        </div>
                                        <div>
                                            <svg fill=currentColor class="question-chevron group-hover:bg-gray-500 h-5 block text-indigo-800 bg-gray-400 rounded-full p-1" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="currentColor" stroke-width="1" fill=currentColor fill-rule="evenodd">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                    Yes. Let's talk, contact us via our contact section or by clicking <a href="https://snapinsight.net/contactus.php">here</a> 
                                </dd>
                            </div>
                        </div>
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                    We are very active on social media. Follow us by searching for snapinsight on social media platforms.
                                </dd>
                            </div>
                        </div>
                        <div class="lg:w-1/2">
                            <div class="question-and-answer select-none cursor-pointer border-2 mx-8 my-3 px-6 py-4 rounded-lg text-sm group">
                                <dt class="question">
                                    <div class="flex justify-between">
                                        <div class="text-indigo-800 font-semibold">
                                           How do I access your solutions?
                                        </div>
                                        <div>
                                            <svg fill=currentColor class="question-chevron group-hover:bg-gray-500 h-5 block text-indigo-800 bg-gray-400 rounded-full p-1" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="currentColor" stroke-width="1" fill=currentColor fill-rule="evenodd">
                                ...
                                <dd class="answer hidden mt-2 leading-snug text-gray-700">
                                    By downloading apps from Play Store and/or App Store. Stay informed about our solutions by joining our mailing services.
                                </dd>
                            </div>
                        </div>
                    </dl>
        ...
        <?php include 'shortcuts/main_footer.html' ?>
        <script
