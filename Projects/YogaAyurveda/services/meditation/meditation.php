<?php
  ...
  $id =  $_GET['meditation'];
  $query = "SELECT * FROM meditation where meditation_id = '$id' ";
  ...
  $pdf_id = $row['meditation_pdf'];
  $query = "SELECT * FROM pdf WHERE pdf_id='$pdf_id'";
  $p = mysqli_query($db, $query);
  $pdf = mysqli_fetch_assoc($p);

  $serve_title = $row['meditation_name'];
  $s_tag = $row['meditation_tag'];
  if($s_tag == 'None'){
    $s_tag = 'Meditation';
  }
  
  if(isset($_POST['enquiry'])){
    $get = 'Meditation-'.$s_tag.':-'.$serve_title;
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="index.php">Meditation</a></li>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-md-1" style="text-align:center;">
              <h3><?= $row['meditation_longintro']; ?></h3>
              <p class="font-italic">
        ...
        <div class="container">
          ...
          <div class="row counters">
            ...
            <div class="col-lg-6 col-12 text-center">
              <span style="font-size:70px" data-toggle="counter-up"><?= $row['meditation_hours']; ?></span>
              <p style="font-size:30px">Hours</p>
            </div>

            <div class="col-lg-6 col-12 text-center" >
              <span style="font-size:70px" data-toggle="counter-up"><?= $row['meditation_cost']; ?></span>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 py-2">
              <form action="meditation.php?meditation=<?=$id?>" method="post">
              <p class="text-white">
