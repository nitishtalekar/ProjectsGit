...
if(empty($_SESSION['admin'])){
  header('location: index.php');
	...
	if(isset($_POST['teacher_info'])){
		...
		$qu = "INSERT INTO teacher(teacher_name, teacher_dept) VALUES ('$name','$dept');";
		mysqli_query($db, $qu);
...
<body><?php include($_SERVER['DOCUMENT_ROOT']."/FeedbackNew/include/header.php")?>
	...
	<div class="container-contact100">
		<div class="wrap-contact100" style="width:800px;">
			<form class="contact100-form validate-form" action="Add_teacher.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="wrap-input100 bg2">
          <center><label class="label-inputx"> <?php echo $_SESSION['dept'];  ?></label></center>
				...
				<div class="wrap-input100 bg1">
					<span class="label-input100">Teacher Name</span>
