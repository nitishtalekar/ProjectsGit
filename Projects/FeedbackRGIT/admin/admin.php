...
if(isset($_POST['mode'])){
  ...
  header('location: Input/Mode');
}

if(isset($_POST['mails'])){

  header('location: Input/Mails');
}
...
<body><?php include($_SERVER['DOCUMENT_ROOT']."/FeedbackRGIT/include/header.php")?>
	...
	<div class="container-contact100">
        ...
        <div class="wrap-input100 rs1-wrap-input100" style="margin-bottom: 0px;padding-bottom: 30px;">
          ...
          <div class="container-contact100-form-btn p-b-5">
  					<button type="submit" class="contact100-form-btn" name="mails">
  						<span>
  							Mail List
  							<i class="fa fa-long-arrow-right m-l-7" aria-hidden="true"></i>
  						</span>
        ...
        <div class="wrap-input100 rs1-wrap-input100" style="margin-bottom: 0px;padding-bottom: 30px;">
          ...
          <div class="container-contact100-form-btn p-b-5">
  					<button type="submit" class="contact100-form-btn" name="mode">
  						<span>
  							Mode of Feedback
  							<i class="fa fa-long-arrow-right m-l-7" aria-hidden="true"></i>
  						</span>
